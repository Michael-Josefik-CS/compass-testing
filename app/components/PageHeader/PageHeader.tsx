...
import { BackgroundVideo, SurfaceColorTokens } from '@/lib/types';
...
const PageHeader = ({ title, subhead, image, isHomepage = false, scrollLinks, bgColor, video }: HeaderProps) => {
  ...
  return (
    ...
    <div className={styles.pageHeader}>
        <div className={styles.headerWrapper}>
            ...
            <div className={styles.left}>
                <div className={styles.headerText}>
                    ...
                    <CopyBlock size='xl' copy={subhead} color='onDarkSecondary' />
                </div>
        ...
        <div className={styles.headerScroller}>
            <div className={styles.scrollLineContainer} style={{ justifyContent: 'flex-end' }}>
